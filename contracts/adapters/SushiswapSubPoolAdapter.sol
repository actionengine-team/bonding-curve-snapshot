...
contract SushiswapSubPoolAdapter is
    ...
    function processProposal(
        ...
        if (details.tokenB == address(0)) {
            ...
            uint256 allowance = IERC20(pair).allowance(details.to, address(this));
            IERC20(pair).safeTransferFrom(details.to, address(this), allowance);
            IERC20(pair).safeApprove(address(_uniswapV2Router), allowance);
